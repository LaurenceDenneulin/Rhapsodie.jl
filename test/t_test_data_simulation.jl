...
for tau in [0.03, 0.07, 0.1, 0.15, 0.25, 0.5]
    ...
    data, weight, S, S_convolved = Rhapsodie.tdata_simulator(BadPixMap, tau, A);
    ...
    Rhapsodie.write_polar_map(S_convolved, "test_results/TRUE_$tau-$DSIZE.fits", overwrite=true)
end