...
function calculate_ssim_for_prima(X::Vector{Float64})
    ...
    crop!(x_est)
    write_polar_map(x_est, "test_results/prima/contrast_10e$(k)/$(regul_type)_regul/RHAPSODIE_$(λ_1)_$(λ_2)_$(α).fits", overwrite=true)
    curr_ssim = Rhapsodie.SSIM(x_est, true_polar_map)
    ssim_entry = [k, λ_1, λ_2, α, curr_ssim[8], curr_ssim[9], curr_ssim[10]]
